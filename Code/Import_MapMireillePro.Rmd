...
TropicFull<-ggplot() + 
  geom_rect(data=d5, mapping=aes(xmin=x1, xmax=x2, ymin=y1, ymax=y2), fill = "transparent", color="darkblue", linetype = "dashed", alpha=0.7) +
...
data_textTropicFullRainbowDeep <- data.frame(label = c('Deep:~Clades~HLI~~LLII/III~~LLIV'))
...
data_textSummerFullRainbowDeep <- data.frame(label = c('Deep:~Clades~HLI~~LLII/III~~LLIV'))
d=data.frame(x=c(400,700,700), y=c(100,100,200), t=c('a', 'a', 'a'), r=c(1,2,3))
...
data_textSpringFullRainbowDeep <- data.frame(label = c('Deep:~Clades~HLI~~LLII/III~~LLIV'))
d=data.frame(x=c(400,700,700), y=c(100,100,200), t=c('a', 'a', 'a'), r=c(1,2,3))
...
```{r}
data_textTropicOMZRainbowSurface <- data.frame(label = c('Near~surface:~Clades~HLI~~LLII/III~~LLIV'))
data_textTropicOMZRainbowDeep <- data.frame(label = c('Deep:~Clades~HLI~~LLII/III~~LLIV'))
d=data.frame(x=c(400,700,700), y=c(100,100,200), t=c('a', 'a', 'a'), r=c(1,2,3))
...
data_textSummerOMZRainbowSurface <- data.frame(label = c('Near~surface:~Clades~HLI~~LLIV'))
data_textSummerOMZRainbowDeep <- data.frame(label = c('Deep:~Clades~HLI~~LLII/III~~LLIV'))
d=data.frame(x=c(400,700,700), y=c(100,100,200), t=c('a', 'a', 'a'), r=c(1,2,3))
...
data_textSpringOMZRainbowSurface <- data.frame(label = c('Near~surface:~Clades~HLI~~LLII/III~~LLIV'))
data_textSpringOMZRainbowDeep <- data.frame(label = c('Deep:~Clades~HLI~~LLII/III~~LLIV'))
d=data.frame(x=c(400,700,700), y=c(100,100,200), t=c('a', 'a', 'a'), r=c(1,2,3))
...
data_textWinterOMZRainbowDeep <- data.frame(label = c('Deep:~Clades~LLII/III~~LLIV'))
d=data.frame(x=c(400,700,700), y=c(100,100,200), t=c('a', 'a', 'a'), r=c(1,2,3))
