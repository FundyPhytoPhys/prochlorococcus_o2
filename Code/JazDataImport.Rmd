...
#DataIn <- file.path("..", "Jaz", fsep = .Platform$file.sep)
DataIn <- file.path("..", "MultiCultiSpectra", fsep = .Platform$file.sep)

#ExpDate <- "20220520"
DataOut<- file.path("..", "ImportedData", "Jaz", fsep = .Platform$file.sep)
#CatalogGoogle <- "https://docs.google.com/spreadsheets/d/1ZXpwR7Gfto-uRzVdXzMpQF4frbrvMLH_IyLqonFZRSw/edit#gid=0"
...
JazSpec <- JazSpec %>% 
  ...
  separate(col = Filename, into = c("Instrument","Date", "MultiCulti", "Par", "WL"), sep = "([\\/\\/\\_\\_\\_\\_\\_\\_\\.])", remove = FALSE)
