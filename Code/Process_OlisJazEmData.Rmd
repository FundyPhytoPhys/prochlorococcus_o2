...
# Left join Olis whole cell absorbance data with Jaz MC emission data. Emission measurements were performed on the mixed color MCMIX004 and the white light MC257 Multicultivators
...
OlisJazMetaData <- OlisJazMetaData %>% 
  filter(E_days != 1) %>%  # remove absorbance spectra data collected during lag phase
  group_by(SampleID, E_days) %>%
