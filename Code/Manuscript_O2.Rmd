...
PurParPlot_cap <- glue("**Peak Photosynthetically Usable Radiation (PUR) (µmol photons m^-2^ s^-1^) vs. peak Photosynthetically Active Radiation (PAR) (µmol photons m^-2^ s^-1^).**",
                       "The correlation between PAR, plotted on the x-axis and PUR, plotted on the y-axis, are coloured for each actinic spectral waveband; 450 nm (blue circles), 660 nm (red circles) and white LED (black circles).",
...
MED4PAR_cap <- glue("**Chlorophyll specific growth rate (d^-1^) for *Prochlorococcus marinus* MED4 (High-Light (HLI) near surface clade) vs. photoperiod (h).**",
                    ...
                    "Columns separate data from 3 levels of peak actinic Photosynthetically Active Radiation (PAR); 30, 90 and 180 µmol photons m^-2^ s^-1^.",
