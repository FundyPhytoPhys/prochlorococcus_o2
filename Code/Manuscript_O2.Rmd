...
knitr::write_bib(c("knitr", "tidyverse", "lubridate", "ggplot2", "broom", "grid", "bookdown", "glue", "cowplot", "ggpubr", "ggh4x", "png", "Studio", "zoo", "photobiology", "photobiologyWavebands", "data.table", "googlesheets4",  "mgcv", "minpack.lm",  "tagger", 'RPackages.bib'))
...
CladeProchloroPhotosynthDepthO2_cap <- glue("**Ocean detection of *Prochlorococcus marinus* photosynthesis complexes.**", 
                       ...
                       "Rows separate data annotated as from *Prochlorococcus* clades: HLI (includes *P. marinus* MED4), HLII, LLI, LLII/III (includes P. marinus* SS120) and LLIV (includes *P. marinus* MIT9313).",
...
FtsHTable <- tibble(Organism = c("*Prochlorococcus marinus*", "*Synechocystis sp. PCC6803*", "Function"),
                    FtsH1 = c("FtsH1", "SlrO228", "PSII Repair"),
...
OverlayPlots_cap <- glue("**Normalized absorbance and Photosynthetically Usable Radiation for *Prochlorococcus marinus* MED4 (A,B,C); SS120 (D,E,F); MIT9313 (G,H,I) grown under three emission wavebands.**",
...
ProchlorococcusLightEnzymes_cap <- glue("**Genes encoding enzymes activated or inhibited by light.**",
                         "The y-axis represents  *Prochlorococcus marinus* strains.",
                         "The x-axis represents enzymes encoded for DNA repair found in at least one *Prochlorococcus marinus* strain in this study.",
                         "Point size indicate gene counts.",
                       "Figure was generated using a filtered subset of the annotated phytoplankton gene sequences dataset from Omar *et al*. [@omarAnnotationGenesEncoding2023].",
...
readRDS(file.path(DataIn,"ProchlorococcusEnzymeTable.Rds")) %>% 
  knitr::kable(.,
             caption = "Enzyme Commission numbers (EC) and corresponsing enzyme names.",
            col.names =  c("EC",
                          "Enzyme Name",
                          "Kegg Orthology")
             )
