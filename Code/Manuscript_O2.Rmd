...
To calculate the Photosynthetic Usable Radiation (PUR), a proxy of photons absorbed, for each *P. marinus* ecotype, the imposed Photosynthetic Active
...
The applied photoperiod was administered using the sine circadian light function of the PSI Multicultivator to simulate light exposure approximating sun rise through to sunset. The area under a sine curve is approximately equivalent to the area of a triangle, therefore the equation to determine the cumulative diel absorbed PUR (µmol photons m^-2^ d^-1^) is one half of the base (photoperiod) multiplied by the height (PUR) (equation \@ref(eq:SumPURDay)),
