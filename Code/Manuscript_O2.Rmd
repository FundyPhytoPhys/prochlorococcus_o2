...
```{r ProchloroElectronTrans, fig.cap = ProchloroElectronTrans_cap , fig.height = 20, fig.width = 10, echo = FALSE}

ProchloroElectronTrans_cap <- glue("**Occurance of electron transport complexes data from the Ocean Protein Portal. X-axis is the oxygen concentration (µM) and the y-axis indicates the depth (m) of occurance**",
                       "Rows are...",
                       "Columns are...",

                       .sep = " ")

knitr::include_graphics(file.path(FiguresInOceanPro, "ProchloroElectronTrans.png"))
```
...
MED4GAM_cap <- glue("** The Generalized Additive Models (GAM) for red light at 660 nm and blue light at 450 nm.  The x-axis is photoperiod (h) and the y-axis is the Photosynethetic Active Radiation (PAR) (µmol photons m^-2^ s^-1^) **",
                       "Rows are...",
                       "Columns are...",
...
SS120GAM_cap <- glue("** The Generalized Additive Models (GAM) for red light at 660 nm and blue light at 450 nm.  The x-axis is photoperiod (h) and the y-axis is the Photosynethetic Active Radiation (PAR) (µmol photons m^-2^ s^-1^) **",
                       "Rows are...",
                       "Columns are...",
...
MIT9313GAM_cap <- glue("** The Generalized Additive Models (GAM) for red light at 660 nm and blue light at 450 nm.  The x-axis is photoperiod (h) and the y-axis is the Photosynethetic Active Radiation (PAR) (µmol photons m^-2^ s^-1^) **",
                       "Rows are...",
                       "Columns are...",
...
```{r ProchloroMetabDepthO2, fig.cap = ProchloroMetabDepthO2_cap , fig.height = 20, fig.width = 10, echo = FALSE}

ProchloroMetabDepthO2_cap <- glue("**Protein turnover complexes data from the Ocean Protein Portal. The x-axis is the oxygen concentration (µM) and the y-axis indicates the depth (m) of occurance**",
                       "Rows are...",
                       "Columns are...",
