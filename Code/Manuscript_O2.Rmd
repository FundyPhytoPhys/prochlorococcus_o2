...
@ulloaCyanobacteriumProchlorococcusHas2021; @partenskyProchlorococcusAdvantagesLimits2010], and may be net O~2~ consumers [@partenskyComparisonPhotosyntheticPerformances2018]. Clades LLII and LLIII are grouped together as the second oldest phylogenetic lineages diversifying in the *P. marinus* radiation, and share an affinity for low light; LLIII cultured strain SS120, was isolated from 135 m depth in the Sargasso Sea. Clade LLI  includes cultured strain NATL2A, which prefers moderate irradiance typically between 30 and 100 m depth.
