...
in June 2019 at https://www.bco-dmo.org/dataset-deployment/730728. This dataset included biomass in the 0.2 to 3.0 micron size fractionated filter size as described in Saito et al., 2014 where *Prochlorococcus* is found. Datasets contained: i) Protein sequences and sample
...
sampling location, all proteins belonging to all subunits of the complex
...
approaches (e.g. parallel reaction monitoring), it is difficult to discern accuracies of strain assignment
