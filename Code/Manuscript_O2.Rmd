...
ProchloroPhotosynthDepthO2_cap <- glue("**Ocean detection of *Prochlorococcus marinus* photosynthesis complexes.**", 
                       ...
                       "Horizontal lines indicate depths equivalent to the Photosynthetically Active Radiation (µmol photons m^-2^ s^-1^) used for later culture growth.",
                       "Vertical lines indicate O~2~ (µM) used for  later culture growth.",
