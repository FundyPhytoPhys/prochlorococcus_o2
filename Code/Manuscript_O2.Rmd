...
MED4PAR_cap <- glue("**Chlorophyll specific growth rate (d^-1^) for *Prochlorococcus marinus* MED4 (High-Light (HLI) near surface clade) vs. photoperiod (h).  **",
                    ...
                    "Columns separate data from 3 levels of actinic Photosynthetically Active Radiation (PAR); 30, 90 and 180 µmol photons m^-2^ s^-1^.",
...
deltaODLogGrowthPlot_cap <- glue("**Fitting chlorophyll specific growth rate for each tube in the Multicultivator.**",
                                 ...
                                 "The right y-axis is actinic PAR levels (µmol photons m^-2^ s^-1^); colours represent the actinic spectral waveband: 450 nm (blue points) or 660 nm (red points).",
