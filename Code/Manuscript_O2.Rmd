...
knitr::kable(MaxGrowthTable,
             caption = "The maximum growth rate, µ~max~ (d^-1^) achieved for each O~2~ experiment, for each strain, with the corresponding photoperiod, PAR level and spectral waveband.",
            col.names =  c("Strain",
                          "Photoperiod (h)",
