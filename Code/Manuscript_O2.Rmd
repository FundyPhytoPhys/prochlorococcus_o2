...
PurParPlot_cap <- glue("**The absorbed Photosynthetically Usable Radiation (PUR) (µmol photons m^-2^ s^-1^) vs. the Photosynthetically Active Radiation (PAR) (µmol photons m^-2^ s^-1^).**",
                       "The correlation between PAR, plotted on the x-axis and absorbed PUR, plotted on the y-axis, are colored for each spectral waveband; blue for 450 nm, red for 660 nm and black for white LED full spectrum light.",
...
ProchloroElectronTrans_cap <- glue("**Occurance of electron transport complexes data from the Ocean Protein Portal. X-axis indicates the depth (m) of occurance and the y-axis is the oxygen concentration (µM) **",
                       "Rows are...",
                       "Columns are...",
...
MED4GAM_cap <- glue("** The Generalized Additive Models (GAM) for red light at 660 nm and blue light at 450 nm.  The x-axis is photoperiod (h) and the y-axis is the Photosynethetic Active Radiation (PAR) (µmole photons m-2 s-1) **",
                       "Rows are...",
                       "Columns are...",
...
ProchloroMetabDepthO2_cap <- glue("**Protein turnover complexes data from the Ocean Protein Portal. X-axis indicates the depth (m) of occurance and the y-axis is the oxygen concentration (µM) **",
                       "Rows are...",
                       "Columns are...",
