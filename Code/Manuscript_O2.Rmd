...
Radiation (PAR), the dotted line, under each imposed spectral wavebands for *P. marinus* MED4, SS120 and MIT9313, respectively. A complete list of absorbed PUR (µmol photons m^-2^ s^-1^) for all imposed spectral wavebands, PAR and photoperiod regimes, can be found in Table \@ref(tab:PURTable).
