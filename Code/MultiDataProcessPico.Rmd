...
Project <- "PICO"
DataIn <- file.path("..", "Data", "ImportedData", "MultiCultiData")
DataOut <- file.path("..", "Data","ProcessedData", "MultiCultiData")
...
```{r set colours}
MyWavelengths = c(405, 445, 470, 530, 620, 660, 730, "WW")
MCMIXColours = c(c(w_length2rgb(405), w_length2rgb(445), w_length2rgb(470), w_length2rgb(530),            w_length2rgb(620), w_length2rgb(660), w_length2rgb(730), "black"))
...
```{r read ProcessFile}
ProcessFile <- "../Data/ImportedData/MultiCultiData/20211223_PICO_MCMIX006_RUN42_TargetDataMetaFilter.Rds"
...
# mutate(GrowthFlag = if_else((OD720_Lintercept + OD720_Lintercept_se) < ((OD720_Lmax - OD720_Lmax_se) & (OD720_Lmu_se < OD720_Lmu * GrowthFlagError) & (OD720_Lmax_se < OD720_Lmax * GrowthFlagError) ), 1, 0)) %>%
  ...
  theme_bw() +
  labs(title = "Logistic cell scatter growth rates - High std error fits omitted")
...
ProcessDataNestGrowth %>%
 ...
 # mutate(GrowthFlag = if_else((deltaOD_Lintercept + deltaOD_Lintercept_se) < ((deltaOD_Lmax - deltaOD_Lmax_se) & (deltaOD_Lmu_se < deltaOD_Lmu * GrowthFlagError) & (deltaOD_Lmax_se < deltaOD_Lmax * GrowthFlagError) ), 1, 0)) %>%
  ...
  facet_grid (cols = vars(Strain), rows = vars(O2)) +
  theme_bw() +
  labs(title = "Logistic chlorophyll specific growth rates - High Std error fits omitted")
