...
MIT9313ProteinAttonated <- TargetProtein %>%
  filter( Strain == "MIT9313") %>% 
  ggplot(aes(x=Target, y= Target_TotalProtein_fmole_ug)) +
  geom_col() +
...
MIT9313ProteinAttonated


MED4ProteinAttonated <- TargetProtein %>%
  filter( Strain == "MED4") %>% 
  ggplot(aes(x=Target, y= Target_TotalProtein_fmole_ug)) +
  geom_col() +
...
MED4ProteinAttonated
```

```{r }

 ggsave(file = file.path(PlotsOut, paste("MED4ProteinAttonated",".png",sep = "")), plot = MED4ProteinAttonated, device = NULL, scale = 1, height=15, width= 25, units = c("cm"),dpi = 300, limitsize = TRUE)

ggsave(file = file.path(PlotsOut, paste("MIT9313ProteinAttonated",".png",sep = "")), plot = MIT9313ProteinAttonated, device = NULL, scale = 1, height=15, width= 25, units = c("cm"),dpi = 300, limitsize = TRUE)
