...
CultureCatalog <- read_sheet("https://docs.google.com/spreadsheets/d/1ZXpwR7Gfto-uRzVdXzMpQF4frbrvMLH_IyLqonFZRSw/edit#gid=0") %>% 
  ...
  filter(str_detect(ID,  "MiSa|JuNa|SaAr")) %>% 
  select(c("PrimaryOperator", "SampleID", "Run", "ID", "Strain", "ExpCul", "ExpDate", "ExpStartTime", "Par_ue", "Photoperiod", "Temp_c", "MC", "Tube", "EndDate","O2", "O2_Category", "WL","LightShape", "Optode","OptodeCh","OptodeMeasure", "ExpEndDate"))          

saveRDS(object = CultureCatalog, file = file.path("..", "Data", "CultureCatalog.Rds"))
