...
ProchlorococcusEnzymeKms_cap <- glue("**Comparison of log~10~(K~m~ for O~2~ in µM) vs.genes encoding O~2~ utilizing enzymes in *Prochlorococcus***, faceted by their respective strains.",
