...
ggsave(filename = file.path(Figures, "Fig12.tiff"), plot = DNARepairFig, height =5 , width = 5, compression = "lzw")
```
...
ggsave(filename = file.path(Figures, "S5_Fig.tiff"), plot = ProchlorococcusLightEnzymesFig, height = 5, width = 6, compression = "lzw")
```
