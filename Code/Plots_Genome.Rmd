...
PLOSFiguresRoundX <- file.path("..", "Output", "PLOSFiguresRound1")
...
ggsave(filename = file.path(Figures, "ProchlorococcusEnzymeKms.png"), plot = ProchlorococcusEnzymeKms, height = 20, width = 17)
