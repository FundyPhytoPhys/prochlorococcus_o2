...
OD720_unnest <- LogFitsData %>%
  select(c(Filename, Tube, ExpDate, MC, PrimaryOperator, Run,  SampleID, Strain, ExpCul, ExpStartTime, Par_ue, Photoperiod, Temp_c, O2, WL, LightShape, Optode, OptodeCh, OptodeMeasure, ExpEndDate, ExpEndHour, SetActinic_day, tubedata, minRollMeanOD720, maxRollMeanOD720, minRollMeandeltaOD, maxRollMeandeltaOD,  GrowthAmpOD720_14days,  GrowthAmpdeltaOD_14days, OD720_logistic_tidied, OD720_logistic_predict, O2_Category)
         ) %>%
...
Pivot_Longer_OD720_est <- NestedFitsData %>%
  select(c(Filename, Tube, SampleID, Run, PrimaryOperator, Strain, Par_ue,RateActinic_h, Photoperiod, SetActinic_day, Temp_c, O2, O2_Category,O2_uM, WL, LightShape,  GrowthAmpOD720_14days, GrowthAmpOD720Flag_14days,  OD720_LseGrowthFlag, OD720trunc_LseGrowthFlag,  OD720_Lmu_corr, OD720_Lmax, OD720_Lintercept, OD720trunc_Lmu_corr, OD720trunc_Lmax, OD720trunc_Lintercept
            )) %>%
...
Pivot_Longer_deltaOD_est <- NestedFitsData %>%
  select(c(Filename, Tube, SampleID, Run, PrimaryOperator, Strain, Par_ue, RateActinic_h, Photoperiod, SetActinic_day, Temp_c, O2, O2_Category,O2_uM, WL, LightShape,  GrowthAmpdeltaOD_14days, GrowthAmpdeltaODFlag_14days,  deltaOD_LseGrowthFlag, deltaODtrunc_LseGrowthFlag,  deltaOD_Lmu_corr, deltaOD_Lmax, deltaOD_Lintercept, deltaODtrunc_Lmu_corr, deltaODtrunc_Lmax, deltaODtrunc_Lintercept
            )) %>%
...
saveRDS(object = NestedFitsData, file = file.path(DataOut, paste(Project, "NestedFitsData.Rds",  sep = "_")), ascii = FALSE, version = NULL, compress = TRUE, refhook = NULL)
