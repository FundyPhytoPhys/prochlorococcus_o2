...
ggsave(file = file.path(FigPath, paste("NichesMap_2",".png",sep = "")), height=18, width= 20,  dpi = 300, limitsize = TRUE)
```


```{r save plot}
# ggsave(file = file.path(FigPath, paste("NichesMap_2",".png",sep = "")), height=8, width= 22,  dpi = 300, limitsize = TRUE)
```
...
#points(PhotoperiodDepthFullO2$PhoticperiodPeakSatPAR_h, PhotoperiodDepthFullO2$DepthNames) 
