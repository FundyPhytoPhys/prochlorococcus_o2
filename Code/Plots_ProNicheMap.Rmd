...
RightSide <-ggarrange(BlankPanel,NichesFullO2North, NichesFullO2Equat, BlankPanel,  ncol = 1, nrow = 4, heights = c(0.5, 2,2,3))
FullO2 <- ggarrange(map, RightSide, ncol = 2, nrow = 1)
FullO2


RightSide <-ggarrange(BlankPanel, NichesOMZNorth, NichesOMZEquat, BlankPanel,  ncol = 1, nrow = 4 , heights = c(0.5, 2,2,3))
