...
```{r join figures, fig.height = 4, fig.width = 8, warning = FALSE}
...
# ggsave(file = file.path(PlotsOut, paste("NichesMap",".png",sep = "")), height=12, width= 28,  dpi = 300, limitsize = TRUE)
# 
# ggsave(file = file.path(PlotsOutPLOS, "Fig10.tiff"), plot = NichesMap, device = NULL, scale = 1, height=20, width= 30, units = c("cm"),dpi = 300, compression = "lzw", limitsize = TRUE)
...
# ggsave(file = file.path(PlotsOut, paste("NichesMap_2",".png",sep = "")), height=12, width= 28,  dpi = 300, limitsize = TRUE)
```
...
# ggsave(file = file.path(PlotsOut, paste("NichesMap_3",".png",sep = "")), height=18, width= 20,  dpi = 300, limitsize = TRUE, bg='white')
# 
# ggsave(file = file.path(PlotsOutPLOS, "Fig10.tiff"), device = NULL, scale = 1, height=55, width= 55, units = c("cm"),dpi = 300, compression = "lzw", limitsize = TRUE, bg='white')
```
...
ggsave(file = file.path(PlotsOut, paste("NichesMap_4",".png",sep = "")), height=18, width= 21,  dpi = 300, limitsize = TRUE)
