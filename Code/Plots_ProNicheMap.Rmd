...
LeftSide <-ggarrange(BlankPanel,NichesFullO2North, NichesFullO2Equat, BlankPanel,  ncol = 1, nrow = 4, heights = c(1, 2,2,3))
FullO2 <- ggarrange(LeftSide, map, ncol = 2, nrow = 1)
FullO2


LeftSide <-ggarrange(BlankPanel, NichesOMZNorth, NichesOMZEquat, BlankPanel,  ncol = 1, nrow = 4 , heights = c(1, 2,2,3))
FullOMZ <- ggarrange(LeftSide, map, ncol = 2, nrow = 1)
FullOMZ
