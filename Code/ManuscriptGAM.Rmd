...
# Plot red light GAM, must change GAMStrain and rerun chunk to generate plot of each strain
``` {r GAM Plot Red WL}
...
# Plot blue light GAM, must change GAMStrain and rerun chunk to generate plot of each strain
``` {r GAM Plot Blue WL}
GamStrain = "MIT9313" # MIT9313 MED4 SS120
GamColor = "Blue"
WL_nm = 450 
