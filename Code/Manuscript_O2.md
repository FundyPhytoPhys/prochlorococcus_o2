...
PSI Multicultivators (Fig. <a href="#fig:LabeledMC">13</a>; PSI, Drásov, Czech
...
Fig. <a href="#fig:deltaODLogGrowthPlot">14</a> is an example of chlorophyll
...
Fig. <a href="#fig:OverlayPlots">15</a> provide visual representations of PUR,
...
MED4 (A-C), SS120 (D-F) and MIT9313 (G-I). Fig.
...
complexes, for clades HL, LLI, LLII/III and LLIV (Fig.
<a href="#fig:CladeProchloroPhotosynthDepthO2">2</a>) as a function of depth (a
...
increased with higher imposed PAR and longer photoperiods (Fig.
<a href="#fig:MED4PAR">3</a>), across all spectral wavebands. No growth was
...
spectral waveband, across PAR levels (Fig. <a href="#fig:MED4PAR">3</a>). The
µ~max~ was
0.65
d^-1^ (Table <a href="#tab:MaxGrowthTable">3</a>) achieved under 180 µmol photons
...
(Fig. <a href="#fig:MED4GAM">4</a>C). Growth decreased with decreasing
...
PAR was similar (Fig. <a href="#fig:MED4GAM">4</a>A). Note the exclusion of MED4
from growth under 4 h photoperiod under both red and blue light (Fig.
<a href="#fig:MED4GAM">4</a>). Under 25 µM O~2~ MED4 showed similar growth
...
peak PAR and across all spectral wavebands (Fig. <a href="#fig:SS120PAR">5</a>).
...
was able to grow (Fig. <a href="#fig:SS120PAR">5</a>). In contrast to the growth
...
µM (Fig. <a href="#fig:SS120PAR">5</a>). 2.5 µM O~2~ growth experiments were not
...
the 90^th^ percentile fastest growth rates under 250 µM O~2~ (Fig.
<a href="#fig:SS120GAM">6</a>D). Under red light and 25 µM O~2~ (Fig.
<a href="#fig:SS120GAM">6</a>B) SS120 grew across most conditions of peak PAR and
...
s^-1^ peak PAR, (Fig. <a href="#fig:MIT9313PAR">7</a>). Under intermediate 90
...
photoperiods for all spectral wavebands tested (Fig.
<a href="#fig:MIT9313PAR">7</a>), with the fastest overall growth rate for MIT9313
1.01
...
(Fig. <a href="#fig:MIT9313PAR">7</a>). Growth estimates showed scatter among
...
![Fig 7: **Chlorophyll specific growth rate (d^-1^) for *Prochlorococcus marinus* MIT9313 (Low-Light (LLIV) deep ocean clade) vs. photoperiod (h). ** Rows separate data from levels of imposed dissolved O~2~ concentrations (250 µM, 25 µM and 2.5 µM). Columns separate data from 3 levels of peak imposed Photosynthetically Active Radiation (PAR; 30, 90 and 180 µmol photons m^-2^ s^-1^). Colours represent the imposed spectral waveband (nm). Large circles show mean or single determinations of growth rate from logistic curve fits; small circles show values for replicate determinations, if any: replicates often fall with larger circles.](../Output/Figures/MIT9313PAR.png)

\newpage

The GAM model in Fig. <a href="#fig:MIT9313GAM">8</a> summarizes MIT9313 growth
responses to red (A-C) or blue (D-F) peak PAR and photoperiod. Under
250 µM O~2~, Fig. <a href="#fig:MIT9313GAM">8</a>D shows MIT9313 achieves
...
percentile of achieved growth rates. Fig. <a href="#fig:MIT9313GAM">8</a>D also
...
exploiting higher peak PAR and longer photoperiods. Fig.
<a href="#fig:MIT9313GAM">8</a>E shows that MIT9313 can exploit all blue PAR levels
and most photoperiods with 90^th^ percentile of fastest growth rate
between 30 to 100 µmol photons m^-2^ s^-1^ PAR. Fig.
<a href="#fig:MIT9313GAM">8</a>F shows that MIT9313 maintains growth even under
...
(Fig. <a href="#fig:PhotoperiodPurFitsPlots">16</a>A-C). In parallel MED4
...
x 10^6^ µmol m^-2^d^-1^ (Fig. <a href="#fig:BluevsRedPurFitsPlots">9</a>A and B),
...
more growth per unit diel cumulative PUR (Fig.
...
distinct fits for different photoperiods refer to Fig.
<a href="#fig:PhotoperiodPurFitsPlots">16</a> A-C.

The representative of the LLII/III clade, *P. marinus* SS120 showed
almost no growth under 2.5 µM O~2~ experiments (Fig.
<a href="#fig:PhotoperiodPurFitsPlots">16</a>F). Most 4 h photoperiod treatments of
SS120 also did not grow under 250 µM O~2~ , even when a 4 h photoperiod
delivered cumulative diel PUR equivalent to other photoperiod treatments
(Fig. <a href="#fig:PhotoperiodPurFitsPlots">16</a>D). Again using
...
combination, under 250 µM O~2~ (Fig.
<a href="#fig:PhotoperiodPurFitsPlots">16</a>D).
...
under red light (Fig. <a href="#fig:BluevsRedPurFitsPlots">9</a>E)
[@murphyPhotoinactivationPhotosystemII2017]. For distinct fits for
different photoperiods refer to Fig.
...
(Fig. <a href="#fig:PhotoperiodPurFitsPlots">16</a>G). Under 25 µM O~2~ MIT9313
...
only above about 3.5 x 10^6^ µmol photons m^-2^ d^-1^ (Fig.
<a href="#fig:PhotoperiodPurFitsPlots">16</a>H). MIT9313 growth under 2.5 µM O~2~
...
d^-1^ cumulative diel PUR (Fig. <a href="#fig:PhotoperiodPurFitsPlots">16</a>I).
...
compared to blue, wavebands (Fig.
...
parallel functions (Table <a href="#tab:FtsHTable">1</a>). Upon a shift to higher
...
Table: Table 1: FtsH protease homologs in *Prochlorococcus marinus* and the model cyanobacterium *Synechocystis* sp. PCC6803. Protein homologies between *Prochlorococcus* and *Synechocystis* were determined by multiple sequence alignment with MUSCLE followed by construction of maximum likelihood phylogenetic tree using 1000 bootstrap replicates in MEGAX.
...
and depth, a proxy for peak PAR (Fig.
<a href="#fig:CladeProchloroProteinMetabDepthO2">10</a>). FtsH3, inferred to
mediate PSI assembly, likewise shows a similar pattern between MED4 and
MIT9313 (Fig. <a href="#fig:CladeProchloroProteinMetabDepthO2">10</a>). But only
...
µM for ubiquinol oxidase (non electrogenic) (Fig.
<a href="#fig:ProchlorococcusEnzymeKms">11</a>) is comparable to the lower limit
for growth of MED4 in our experiments (Fig. <a href="#fig:MED4GAM">4</a>). We
suggest that dependence upon this enzyme excludes MED4 from low oxygen
zones. The genome scan shows SS120 and MIT9313 lack this gene (Fig.
<a href="#fig:ProchlorococcusEnzymeKms">11</a>), and therefore, lack this
...
genome (Fig. <a href="#fig:ProchlorococcusEnzymeKms">11</a>). (S)-2-hydroxy-acid
...
higher light. Fig. <a href="#fig:ProchlorococcusEnzymeKms">11</a> also shows that
...
under 25 µM O~2~ and not at all under 2.5 µM O~2~ (Fig.
<a href="#fig:SS120PAR">5</a>).
...
Fig. <a href="#fig:DNARepairFig">12</a> shows genes encoding DNA repair for *P.
...
deoxyribodipyrimidine photolyase (Fig. <a href="#fig:DNARepairFig">12</a> and
<a href="#fig:ProchlorococcusLightEnzymes">17</a>), which, in the presence of blue
...
![Fig 12: **Genes encoding DNA repair enzymes.** The y-axis represents *Prochlorococcus marinus* strains. The x-axis represents enzymes encoded for DNA repair found in at least one *Prochlorococcus marinus* strain in this study. Point size indicate gene counts. Figure was generated using a filtered subset of the annotated phytoplankton gene sequences dataset from Omar *et al*. [@omarAnnotationGenesEncoding2023].](../Output/Figures/DNARepairFig.png)
...
d^-1^ of PUR (Fig. <a href="#fig:PhotoperiodPurFitsPlots">16</a>E and H), comparable
...
m^-2^ d^-1^ (Fig. <a href="#fig:PhotoperiodPurFitsPlots">16</a>A and B). Growth under
lower O~2~ allowed MIT9313 to substantially increase its exploitation of
higher diel PUR (Fig. <a href="#fig:PhotoperiodPurFitsPlots">16</a>I).
...
O~2~. Genomic (Fig. <a href="#fig:ProchlorococcusEnzymeKms">11</a>) and
...
consistent with Fig. <a href="#fig:CladeProchloroPhotosynthDepthO2">2</a>
...
compared to 250 µM O~2~ (Fig. <a href="#fig:PhotoperiodPurFitsPlots">16</a>).
...
genomic limitations on capacity for DNA repair (Fig.
<a href="#fig:DNARepairFig">12</a>), and possibly by limited capacity for synthesis
of reactive oxygen quenchers (Fig.
<a href="#fig:ProchlorococcusEnzymeKms">11</a>). Our growth results are supported
...
levels are higher, within OMZ, and by Fig.
<a href="#fig:CladeProchloroPhotosynthDepthO2">2</a> showing PSII protein subunits
...
conditions of 25 µM and 2.5 µM (Fig. <a href="#fig:MIT9313PAR">7</a>), enabling
...
µM (Fig. <a href="#fig:ProchlorococcusEnzymeKms">11</a>), which produces
...
Fig. <a href="#fig:CladeProchloroPhotosynthDepthO2">2</a> showing PSI protein
