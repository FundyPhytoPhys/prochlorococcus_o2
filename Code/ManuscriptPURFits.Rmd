...
MED4PURFITPlot <- AllFitsCombined |>
 ...
 geom_text(aes(x = 1000, y = 0.75, label= "A     MED4 HLI"), data = . %>% filter(O2_uM == 250, Strain == "MED4"), size = 3, hjust = 0, vjust = 0) +
 ...
 guides(shape = guide_legend(nrow = 1)) +
  theme_bw() +
   theme( strip.text = element_text(size = 10),
        ...
        axis.text.y = element_text(size = 7, color = "black", angle = 0, hjust = 1.0),
...
SS120PURFITPlot <- AllFitsCombined |>
 ...
 geom_text(aes(x = 1000, y = 0.75, label= "B     SS120 LLII/III"), data = . %>% filter(O2_uM == 250, Strain == "SS120"), size = 3, hjust = 0, vjust = 0) +
  scale_x_continuous(label=scientific_10) +
   scale_y_continuous(breaks = c(0,0.25, 0.5, 0.75, 1.0), limits = c (0, 1.05)) +
...
MIT9313PURFITPlot <- AllFitsCombined |>
 ...
 geom_text(aes(x = 1000, y = 0.75, label= "C     MIT9313 LLIV"), data = . %>% filter(O2_uM == 250, Strain == "MIT9313"), size = 3, hjust = 0, vjust = 0) +
