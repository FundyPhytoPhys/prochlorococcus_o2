...
# PhotoperiodPurFitsPlots <- plot_grid(MED4PURFITPlot, SS120PURFITPlot, MIT9313PURFITPlot, ncol = 1)
# 
...
# 
# #add to plot
# PhotoperiodPurFitsPlots <- grid.arrange(arrangeGrob(PhotoperiodPurFitsPlots, left = y.grob))
...
PhotoperiodPurFitsPlots <- AllFitsCombined |>
  unnest(cols = c(Data_all), names_sep = "_", keep_empty = TRUE) |>
  mutate(PhotoperiodLabelTitle = "Photoperiod (h)",
         OxygenLabel = "Oxygen Concentration (µM)",
         Photoperiod = factor(Data_all_Photoperiod, levels = c(16, 12, 8, 4)),
...
# PhotoperiodPurFitsPlots <- tag_facet(PhotoperiodPurFitsPlots, open = "", close = "", tag_pool = LETTERS, size = 8)
...
ggsave(file = file.path(PlotsOut, paste("PhotoperiodPurFitsPlots",".png",sep = "")), plot = PhotoperiodPurFitsPlots, device = NULL, scale = 1, height=30, width= 44, units = c("cm"),dpi = 300, limitsize = TRUE)

ggsave(file = file.path(PlotsOut, paste("PhotoperiodPurFitsPlots",".tiff",sep = "")), plot = PhotoperiodPurFitsPlots, device = NULL, scale = 1, height=30, width= 44, units = c("cm"),dpi = 300, limitsize = TRUE)
