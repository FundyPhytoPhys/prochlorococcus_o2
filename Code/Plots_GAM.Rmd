...
(ContourIntO2 <- ggplot(na.omit(HyperChlPlotInt), aes(Photoperiod, Par_ue, z = fit, fill = fit)) + geom_tile() +
    ...
    scale_x_continuous(limits = c(4, 16), breaks = c(4, 8, 12, 16)) +
    scale_y_continuous(limits = c(10, 200))  +
    labs(title = bquote("D.   " ~ .(GamStrain) ~ '  25 µM' ~ "[" ~ O[2]~ "]"), size = 25) +
    xlab("Photoperiod (h)") +
...
(ContourHighO2 <- ggplot(na.omit(HyperChlPlotHigh), aes(Photoperiod, Par_ue, z = fit, fill = fit)) + geom_tile() +
    ...
    scale_x_continuous(limits = c(4, 16), breaks = c(4, 8, 12, 16)) +
    scale_y_continuous(limits = c(10, 200)) +
   # labs(title = bquote("C.   " ~ .(GamStrain) ~ '  250 µM' ~ "[" ~ O[2]~ "]")) +
    xlab("Photoperiod (h)") +
      ylab("PAR (µmol photons"~ m^-2~ ~s^-1~ ")")+
    # xlab(NULL) +
...
test <-  plot_grid(MED4PAR, LabelledCombinedGam, labels = "AUTO", ncol = 1) 
test
```
...
(ContourMED4BlueHigh <- ggplot(na.omit(HyperChlPlot)) + 
    ...
    scale_x_continuous(limits = c(4, 16), breaks = c(4, 8, 12, 16)) +
    scale_y_continuous(limits = c(10, 200)) +
    geom_text(data=data_text, aes(x=6, y=180, label=label), size=4) +
     # geom_text(data=data_textB, aes(x=5, y=190, label=label), size=7) +
   # labs(title = bquote("C.   " ~ .(GamStrain) ~ '  250 µM' ~ "[" ~ O[2]~ "]")) +
    xlab("Photoperiod (h)") +
      ylab("PAR (µmol photons"~ m^-2~ ~s^-1~ ")")+
    # xlab(NULL) +
...
(ContourMED4RedHigh <- ggplot(na.omit(HyperChlPlot)) + 
    ...
    scale_x_continuous(limits = c(4, 16), breaks = c(4, 8, 12, 16)) +
    scale_y_continuous(limits = c(10, 200)) +
    geom_text(data=data_textB, aes(x=5, y=195, label=label), size=7) +
     geom_text(data=data_text, aes(x=6, y=180, label=label), size=4) +
  # labs(title = bquote("C.   " ~ .(GamStrain) ~ '  250 µM' ~ "[" ~ O[2]~ "]")) +
    xlab("Photoperiod (h)") +
      ylab("PAR (µmol photons"~ m^-2~ ~s^-1~ ")")+
