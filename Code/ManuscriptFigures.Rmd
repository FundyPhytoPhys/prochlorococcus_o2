...
MCMIXColours = c("black", w_length2rgb(660), w_length2rgb(450))
...
# ggsave(file = file.path(PlotsOut, paste("MED4NoPhotoPUR",".png",sep = "")), plot = MED4NoPhotoPUR, device = NULL, scale = 1, height=25, width= 40, units = c("cm"),dpi = 300, limitsize = TRUE)
# 
# ggsave(file = file.path(PlotsOut, paste("MIT9313NoPhotoPUR",".png",sep = "")), plot = MIT9313NoPhotoPUR, device = NULL, scale = 1, height=25, width= 40, units = c("cm"),dpi = 300, limitsize = TRUE)
# 
# ggsave(file = file.path(PlotsOut, paste("SS120NoPhotoPUR",".png",sep = "")), plot = SS120NoPhotoPUR, device = NULL, scale = 1, height=25, width= 40, units = c("cm"),dpi = 300, limitsize = TRUE)
...
MyWavelengths = c("WW", 660, 450)
OverlayColours = c("black", w_length2rgb(660),  w_length2rgb(450))
